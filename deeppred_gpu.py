...
path = '/home/test/Downloads/sakino0509/race-predict/model/20220529_072629/20220529_072629_model_epoch=250::Accu=0.07.pth'
paht ='/home/test/Downloads/sakino0509/race-predict/model/20220529_072629/20220529_072629_model_epoch=250::Accu=0.07.pth'
...
with torch.no_grad():
    for i in tqdm(range(ep)):
        ...
        #print(outputs)
        pred = zeros
        print(1+np.argsort(outputs,axis=0).T[:,-3:][0])
        print(np.sort(outputs,axis=0).T[:,-3:][0])
        print(argmax+1)
